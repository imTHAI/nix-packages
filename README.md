...
|---|---|---|---|
| [`keka`](./pkgs/keka) | `1.6.8` | [`1.6.0`](https://github.com/NixOS/nixpkgs/blob/master/pkgs/by-name/ke/keka/package.nix) | several patch releases behind, no auto-update mechanism upstream |
...
| [`cmux`](./pkgs/cmux) | `0.64.25` | not in nixpkgs | frequent releases, macOS-only, no nixpkgs packaging yet |
